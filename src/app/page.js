      ...
      <div className="grid grid-cols-1 justify-center text-center mt-4 mb-6">
        <div>
          <span className="font-extrabold">
            Welcome to Metric Coders Real Estate Virtual Staging Generator!
          </span>
        </div>
        <div>
          <span className="italic">
            This tool generates real estate virtuals using Dall-e-2!
          </span>
        </div>
      </div>
        ...
        <div className="m-2">
          {outputResponse === "" && (
            <span className="justify-center text-center">
              Get your real estate virtual staging here!
            </span>
          )}
